...
//  Brahmaand
//
//  Created by jaydeep on 01/05/21.
//
...
open class ImageScrollView: UIScrollView {
    ...
    private func setMaxMinZoomScalesForCurrentBounds() {
        ...
        // don't let minScale exceed maxScale. (If image is smaller than the screen, we don't want to force zoom it.)
...
extension ImageScrollView: UIScrollViewDelegate {
    ...
    public func scrollViewWillEndDragging(_ scrollView: UIScrollView, withVelocity velocity: CGPoint,
        ...
        imageScrollViewDelegate?.scrollViewWillEndDragging?(scrollView, withVelocity: velocity,
